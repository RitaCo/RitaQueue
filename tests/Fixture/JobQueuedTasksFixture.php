...
/**
 * JobQueuedTasksFixture
 *
 */
class JobQueuedTasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'group' => ['type' => 'string', 'length' => 0, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
...
'engine' => 'InnoDB', 'collation' => 'utf8_persian_ci'
    ...
    public $records = [
        [
            ...
            'created' => '2015-02-08 03:02:23',
            'notbefore' => '2015-02-08 03:02:23',
            'fetched' => '2015-02-08 03:02:23',
            'completed' => '2015-02-08 03:02:23',
            'failed' => 1,
